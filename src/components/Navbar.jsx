...
function Navbar() {
    ...
    return (
    <header className='flex w-full items-center justify-between border-b-2 border-gray-200 bg-white p-3 navbar_container'>
        ...
        <div className="w-48 sm:w-96 flex items-center justify-between p-2">
                    <Link to="/#" className="transition hover:text-blue-600 ">Login</Link>
                    <Link to="/#" className="transition hover:text-blue-600">Products</Link>
                </div>
